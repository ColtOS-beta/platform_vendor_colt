...
PRODUCT_COPY_FILES += \
    ...
    vendor/colt/prebuilt/common/bin/50-lineage.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-lineage.sh
...
# Colt-specific init rc file
PRODUCT_COPY_FILES += \
    vendor/colt/prebuilt/common/etc/init/init.colt-system_ext.rc:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/init/init.colt-system_ext.rc
...
PRODUCT_COPY_FILES += \
    vendor/colt/prebuilt/common/etc/init/init.openssh.rc:$(TARGET_COPY_OUT_PRODUCT)/etc/init/init.openssh.rc
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/colt/overlay/no-rro
PRODUCT_PACKAGE_OVERLAYS += \
    vendor/colt/overlay/common \
    vendor/colt/overlay/no-rro

PRODUCT_PACKAGES += \
    DocumentsUIOverlay \
    NetworkStackOverlay

include vendor/colt/config/branding.mk
